##If Necessary, ensure you have the calibrate package installed
...
plot(rownames(emissionsByYear), emissionsByYear[,1], ylab="", xlab = "Year", type="l", 
     yaxt="n", main="Total Emissions in Baltimore by Year")
...
textxy(rownames(emissionsByYear), emissionsByYear[,1], labs=format(emissionsByYear[,1],
     scientific=FALSE, digits=4), cex=.7, offset= 0)
##Close PNG device
dev.off()